...
var normalize = exports.normalize = function(req,res,next,options) {
	...
	if(unescape(req.originalUrl) != filteredUrl) {
		...
		// Absolute redirect if host and protocol is defined
		if(typeof req.headers != 'undefined' && typeof req.headers.host != 'undefined' && req.protocol != 'undefined') {
			filteredUrl = req.protocol +'://'+req.headers.host+''+filteredUrl;
		}
